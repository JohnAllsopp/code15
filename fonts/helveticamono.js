/*
 ...
 MyFonts Webfont Build ID 2744388, 2014-02-10T20:13:21-0500
 ...
 Webfont: Helvetica Monospaced Std Roman by Linotype
 URL: http://www.myfonts.com/fonts/linotype/helvetica-monospaced/std-roman/

 Webfont: Helvetica Monospaced Std Bold by Linotype
 URL: http://www.myfonts.com/fonts/linotype/helvetica-monospaced/std-bold/


 License: http://www.myfonts.com/viewlicense?type=web&buildid=2744388
 Licensed pageviews: 250,000
 Webfonts copyright: Copyright &#x00A9; 2010 Linotype Corp., www.linotype.com. All rights reserved. This font software may not be reproduced, modified, disclosed or transferred without the express written approval of Linotype Corp. Helvetica is a trademark of Linotype Corp. r

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/29e044";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"HelveticaMonospacedStd-Rg",url:wfpath+"29E044_0"+suffix+"_0."+webfontType},{fontFamily:"HelveticaMonospacedStd-Bd",url:wfpath+"29E044_1"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+";");fonts[i].fontWeight&&(css+="font-weight: "+
